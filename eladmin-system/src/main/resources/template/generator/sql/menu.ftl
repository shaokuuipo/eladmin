...
INSERT INTO sys_menu (pid, sub_count, type, title, name, component, menu_sort, icon, path, i_frame, cache, hidden, permission, create_by, update_by, create_time, update_time)
 VALUES (null, 3, 1, '${apiAlias}', '${changeClassName}List', '${componentPath}', 1, 'menu', '${changeClassName}List', false, false, false, '${changeClassName}:list', 'admin', 'admin', '${.now?string["yyyy-MM-dd HH:mm:ss"]}', '${.now?string["yyyy-MM-dd HH:mm:ss"]}');
